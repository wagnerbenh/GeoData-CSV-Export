var array = [["Street Address", "City", "Zip Code", "Type", "Class", "Document Date", "Amount", "Owner", "Plaintiff", "Contact Name", "Contact Telephone", "Contact Type"]];
...
$("tr#trselectprop").each(function() {
  ...
  $(this).next().find("tbody tr").each(function() {
    ...
    property_array.push(street_address, city, zip, type, property_class, doc_date, amount, owner, plaintiff, contact_name, contact_telephone, contact_type);
